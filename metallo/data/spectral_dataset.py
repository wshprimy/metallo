    ...
    def __init__(
        ...
        if self.spectral_data:
            ...
            if self.is_train:
                ...
                self.end_segment = int(self.segments_per_dos * (self.train_ratio + self.val_ratio))
            else:  # test
                self.start_segment = int(self.segments_per_dos * (self.train_ratio + self.val_ratio))
        ...
        logging.info(f"SpectralDataset: {len(self.dos_values)} DOS values, "
